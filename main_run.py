...
def gen(text):
    try:
        response = client.models.generate_content(
            ...
            câu thứ tư mang văn phong như trong phim kiếm hiệp, cổ trang, đạo lý, tu tiên kiểu như trong phim cổ trang Trung Quốc , sử dụng đan xen các từ Hán Việt.
            ...
            À nhớ đừng cho kí tự gì khác, kể cả [ và ] nhé. Đảm bảo đúng định dạng JSON, không lỗi gì nhé để sau này tôi dễxử ly.
            """
        )
